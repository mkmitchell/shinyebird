shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("species", "Species:", sort(c("Green-winged teal" = "AGWT","Black Duck" = "ABDU", "American Widgeon" = "AMWI", "Black-bellied Whistling-Duck" = "BBWD", "Bufflehead" = "BUFF", "Blue-winged teal" = "BWTE", "Canvasback" = "CANV", "Cinnamon teal" = "CITE", "Common Eider" = "COEI", "Gadwall" = "GADW", "Great Scaup" = "GRSC", "King Eider" = "KIEI", "Lesser Scaup" = "LESC", "Long-tailed Duck"= "LTDU", "Mallard" = "MALL", "Pintail" = "NOPI", "Northern Shoveler" = "NOSH", "Redhead"= "REDH", "Ringed neck" = "RNDU", "Ruddy Duck" = "RUDU", "Wood duck" = "WODU"))),
